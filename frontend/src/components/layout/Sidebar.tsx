...
import { LayoutDashboard, MessageSquare, Database, User, LogOut } from "lucide-react"
      ...
      <div className="flex-1 py-8 px-4 flex flex-col gap-2 overflow-y-auto">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <item.icon className={cn("w-5 h-5", isActive ? "text-brand-light" : "text-foreground/50 group-hover:text-foreground")} />
